...
trainer.evaluateModel(model_path="tennis_data/models", json_path="tennis_data/json/detection_config.json", iou_threshold=0.5, object_threshold=0.3, nms_threshold=0.5)
